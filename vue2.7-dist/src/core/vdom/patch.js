...
import { registerRef } from './modules/template-ref.js';
...
import { isDef, makeMap, isUndef, isTrue, isArray, isPrimitive, isRegExp } from '../../shared/util.js';
import '../util/env.js';
...
export { createPatchFunction, emptyNode };
